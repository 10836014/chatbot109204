...
('ddchaj', '小豬??', NULL, NULL, 'test10@gmail.com', NULL),
('jviofjg', 'ddsv', NULL, NULL, 'scjdkfuhb@vmsfnl', NULL),
('uhukjugrhfjh', '小豬', NULL, NULL, 'test10@gmail.com', NULL);
...
--
ALTER TABLE `chatrooms`
  MODIFY `chatroom_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
